...
<script>
    document.getElementById("add").onclick = function () {
        location.href = "/librarySystem/addUser.jsp"
    }
    document.getElementById("mod").onclick = function () {
        location.href = "/librarySystem/updateUser.jsp"
    }
    document.getElementById("del").onclick = function () {
        location.href = "/librarySystem/deleteUser.jsp"
    }
    document.getElementById("fre").onclick = function () {
        location.href = "/librarySystem/freezeUser.jsp"
    }
</script>
